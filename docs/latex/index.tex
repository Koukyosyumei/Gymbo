...
\DoxyCodeLine{stmt       = \mbox{\hyperlink{parser_8h_a9e2a8633fd8ee1ed723406efc5a82b06}{expr}} \textcolor{stringliteral}{"{};"{}}}
\DoxyCodeLine{         | \textcolor{stringliteral}{"{}\{"{}} stmt* \textcolor{stringliteral}{"{}\}"{}}}
\DoxyCodeLine{         | \textcolor{stringliteral}{"{}if"{}} \textcolor{stringliteral}{"{}("{}} \mbox{\hyperlink{parser_8h_a9e2a8633fd8ee1ed723406efc5a82b06}{expr}} \textcolor{stringliteral}{"{})"{}} stmt (\textcolor{stringliteral}{"{}else"{}} stmt)? }
...
\DoxyCodeLine{\mbox{\hyperlink{parser_8h_a7782376e331d91dd967f5a7b1c23c1ba}{relational}} = add (\textcolor{stringliteral}{"{}<"{}} add | \textcolor{stringliteral}{"{}<="{}} add | \textcolor{stringliteral}{"{}>"{}} add | \textcolor{stringliteral}{"{}>="{}} add)*}
